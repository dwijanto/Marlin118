 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 100 //40        // Seconds
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 100 //20                // Seconds
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 100 //20    // Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS 20 //2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD 100 //60                // Seconds
